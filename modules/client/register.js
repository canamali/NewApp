      ...
      <View style={styles.container}>
        ...
        <TouchableWithoutFeedback onPress={()=>this.props.navigation.navigate('Language')}>
          <View style={styles.button}>
            <Text style={{ color: "#fff", fontSize: 20, fontWeight: "500" }}>Join Us!</Text>
          </View>
        </TouchableWithoutFeedback>
        <TouchableWithoutFeedback onPress={()=>this.props.navigation.navigate('Login')}>
          <Text style={{ color: "#282c34", fontSize: 15, fontWeight: "400" }}>
            Already a member?
            <Text style={{ color: "#06f", fontSize: 15, fontWeight: "400" }}>{" Login"}</Text>
          </Text>
        </TouchableWithoutFeedback>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 25 }}>
          ...
          <View>
            <Text style={{ width: 120, textAlign: 'center' }}>Or Register with</Text>
          </View>
          <View style={{ flex: 1, height: 1, backgroundColor: 'black' }} />
        </View>
